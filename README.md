...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/paranoid_scientist-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13715&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/paranoid_scientist-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `paranoid_scientist` can be installed with:

```
conda install paranoid_scientist
```

It is possible to list all of the versions of `paranoid_scientist` available on your platform with:
